  ...
  return (
    ...
    >
      <aside className="h-full overflow-y-auto">
        <div style={{ backgroundColor: "#1E1E1E", height: 63 }}>
          <List>
            <IconButton onClick={onCartIconClick} style={{ float: "right", margin: "10px 18px 0px 0px" }}>
              <CloseOutlinedIcon style={{ color: "white", fontSize: "1.3rem" }} />
            </IconButton>
          </List>
        </div>
        <Divider />
